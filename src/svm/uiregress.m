...
b = uicontrol('Parent',a, ...
	'Units','points', ...
	'Callback','export_svr', ...
	'Position',[514.5 270.25 68.25 23.25], ...
	'String','Save PDF', ...
	'Tag','Pushbutton1');
b = uicontrol('Parent',a, ...
	'Units','points', ...
...
b = uicontrol('Parent',a, ...
	...
	'Position',[190.75 430.5 23.25 14.25], ...
	'String','1', ...
	'Style','edit', ...
	'Tag','svrEditP1', ...
	'Visible','off');
b = uicontrol('Parent',a, ...
	...
	'Position',[147.75 430.25 39 12.75], ...
	'Style','text', ...
	'Tag','svrTextP1');
b = uicontrol('Parent',a, ...
	'Units','points', ...
	'BackgroundColor',[0.8 0.8 0.8], ...
	'Position',[258.75 430.25 40.5 12], ...
	'String','Bound', ...
	'Style','text', ...
	'Tag','svrTextBound');
b = uicontrol('Parent',a, ...
	'Units','points', ...
	'BackgroundColor',[0.752941 0.752941 0.752941], ...
	'Position',[24 6 450.25 14.25], ...
	'Style','text', ...
	'Tag','svrTextStatus');
b = uicontrol('Parent',a, ...
	'Units','points', ...
	'BackgroundColor',[0.8 0.8 0.8], ...
	'Position',[368.25 430.25 60.75 12], ...
