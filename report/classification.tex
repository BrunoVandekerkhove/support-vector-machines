...
%What's previously discussed can be used on some well-known datasets. These datasets are the Ripley -, Wisconsin breast cancer - and diabetes dataset respectively. They're visualised below and then tackled one by one.
%
%\begin{figure}[htp]
%\centering
