...
\label{bayesianinference}
    ...
    \begin{minipage}{0.45\textwidth}
        ...
        \caption{Results of automatic relevance determination applied to 3-dimensional input data of which only the first dimension models the \texttt{sinc} function, the other 2 being white noise.}
\label{ardsinc}
    \end{minipage}
\end{figure}
...
\begin{figure}[h]
\centering
\subfloat[Non-robust regression.]{\includegraphics[width=0.45\textwidth]{../src/figures/estimation/robustregression_non}}
\\
\subfloat[\textit{Huber} weight function.]{\includegraphics[width=0.45\textwidth]{../src/figures/estimation/robustregression_whuber}}\qquad
\subfloat[\textit{Hampel} weight function.]{\includegraphics[width=0.45\textwidth]{../src/figures/estimation/robustregression_whampel}}
\\
\subfloat[\textit{Logistic} weight function.]{\includegraphics[width=0.45\textwidth]{../src/figures/estimation/robustregression_wlogistic}}\qquad
\subfloat[\textit{Myriad} weight function.]{\includegraphics[width=0.45\textwidth]{../src/figures/estimation/robustregression_wmyriad}}
\caption{Comparing non-robust regression to robust regression with a variety of weight functions. The smalles \textit{mse} on the test set was obtained with the \textit{Hampel} weight function.}
\label{sincestimate}
\end{figure}
