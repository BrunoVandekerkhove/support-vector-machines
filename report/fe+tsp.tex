...
Two downsides of LS-SVMs are the loss of sparsity and the lack of robustness. Outliers can increase the variance of the decision boundary quite a bit.
...
\par The \textit{mean absolute error} penalises outliers less than the \texttt{mean squared error} does as the latter squares the error.
